...
def create_age_plotly_chart(year):
    """지정된 연도의 연령별 고용률 및 실업률 데이터를 Plotly로 시각화하여 Figure 객체를 반환합니다."""
    file_path = 'results/processed_disable_age.xlsx'
    ...
    fig.update_layout(
        title_text=f'<b>{year}년 연령별 고용률 및 실업률</b>',
        title_x=0.5,
        xaxis_title='연령',
        yaxis_title='비율 (%)',
        barmode='group',
